...
public class SpectrumPangolinLineageMutation extends TableImpl<SpectrumPangolinLineageMutationRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SPECTRUM_PANGOLIN_LINEAGE_MUT_COUNTRY_DATE_PANGOLIN_LINEAGE_IDX, Indexes.SPECTRUM_PANGOLIN_LINEAGE_MUT_REGION_COUNTRY_DATE_PANGOLIN__IDX, Indexes.SPECTRUM_PANGOLIN_LINEAGE_MUTA_REGION_DATE_PANGOLIN_LINEAGE_IDX, Indexes.SPECTRUM_PANGOLIN_LINEAGE_MUTATION_DATE_PANGOLIN_LINEAGE_IDX);
    }
