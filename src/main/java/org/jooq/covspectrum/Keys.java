...
public class Keys {
    ...
    public static final UniqueKey<GisaidApiSequenceRecord> GISAID_API_SEQUENCE_PKEY = Internal.createUniqueKey(GisaidApiSequence.GISAID_API_SEQUENCE, DSL.name("gisaid_api_sequence_pkey"), new TableField[] { GisaidApiSequence.GISAID_API_SEQUENCE.GISAID_EPI_ISL }, true);
    ...
    public static final UniqueKey<SpectrumWasteWaterResultRecord> X_SPECTRUM_WASTE_WATER_RESULT_PKEY = Internal.createUniqueKey(SpectrumWasteWaterResult.SPECTRUM_WASTE_WATER_RESULT, DSL.name("x_spectrum_waste_water_result_pkey"), new TableField[] { SpectrumWasteWaterResult.SPECTRUM_WASTE_WATER_RESULT.VARIANT_NAME, SpectrumWasteWaterResult.SPECTRUM_WASTE_WATER_RESULT.LOCATION }, true);
    public static final UniqueKey<SpectrumWasteWaterResultOldRecord> SPECTRUM_WASTE_WATER_RESULTS_PKEY = Internal.createUniqueKey(SpectrumWasteWaterResultOld.SPECTRUM_WASTE_WATER_RESULT_OLD, DSL.name("spectrum_waste_water_results_pkey"), new TableField[] { SpectrumWasteWaterResultOld.SPECTRUM_WASTE_WATER_RESULT_OLD.VARIANT_NAME }, true);
